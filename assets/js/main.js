...
const translations = {
    "pt": {
        ...
        "proj_1_desc": "Automação Python com Selenium e OCR para extração de dados fiscais.",
    ...
    "en": {
        ...
        "proj_1_desc": "Python automation using Selenium and OCR for fiscal data extraction.",
